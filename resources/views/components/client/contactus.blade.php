        ...
        <div class="row g-5 ">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <h1 class="display-6 text-black mb-5">
                    Segera daftarkan diri Anda di SMK Bagi Negeri!
                </h1>
                <p class="text-black mb-5">
                    Pendaftaran PPDB SMKS Bagi Negeri dibuka mulai tanggal 1 Januari 2024 hingga 31 Juli 2024.
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-3">
                        <h5>Alamat</h5>
                        <p class="mb-0">Jl. Raya Merdeka, Tarogong Kidul, Kabupaten Garut, Jawa Barat 44171, Indonesia
                        </p>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-3">
                        <h5>Nomor Telepon</h5>
                        <p class="mb-0">+62 88-200-159-7126</p>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <h5>Email</h5>
                        <p class="mb-0">info@smksbaginegeri.sch.id</p>
                    </div>
                </div>
            </div>
