    ...
    <div class="container">
        <div class="text-center mx-auto" style="max-width: 500px">
            <h1 class="display-6 mb-5">
                Formulir Pendaftaran Online SMK Bagi Negeri
            </h1>
        </div>
            ...
            <form action="{{route('yes_daftar')}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <input type="text" class="form-control" placeholder="Rekomendasi Masuk SMK Bagi Negeri" {{$form}}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Selamat Datang Di Web PPDB SMKS Bagi Negeri 2024 / 2025, ada beberapa aturan sebelum mengisi
                ...
                <p>
                    Terima kasih telah mendaftar di sekolah kami SMK Bagi Negeri, jadi bagian PGRI adalah
