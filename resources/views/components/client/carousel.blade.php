                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-12 col-lg-6">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">SMK Bagi Negeri</h1>
                                <p class="fs-5 text-white mb-5">
                                    {{"Sekolah kejuruan yang berlokasi di Kabupaten Garut, Jawa Barat, kini menerima peserta didik baru untuk tahun ajaran 2024/2025."}}
                                </p>
